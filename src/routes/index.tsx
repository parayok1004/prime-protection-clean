...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professioneller Sicherheitsdienst in Berlin. Objektschutz, Eventschutz und Personenschutz – zuverlässig, diskret und auf höchstem Niveau." },
      { property: "og:title", content: "Prime Protection Service | Sicherheitsdienst Berlin" },
      { property: "og:description", content: "Professioneller Sicherheitsdienst in Berlin." },
    ],
  }),
  component: HomePage,
});
    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl pt-20">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-4 leading-tight">
            Sicherheit
            <span className="block gold-text">auf höchstem Niveau</span>
          </h1>
          <div className="divider-gold mx-auto mb-6" />
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            Prime Protection Service bietet professionellen Sicherheitsdienst in Berlin — zuverlässig, diskret und auf höchstem Niveau.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/security" className="btn-gold text-sm">Unsere Leistungen</Link>
            <Link to="/kontakt" className="btn-outline-gold text-sm">Kontakt</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="mx-auto max-w-3xl">
          <Link to="/security" className="group relative block overflow-hidden rounded-lg border border-border card-hover">
      ...
      <section className="py-24 px-6 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="text-muted-foreground mb-8">
            Wir erstellen Ihnen gerne ein unverbindliches Angebot für unsere Sicherheitsdienstleistungen.
          </p>
